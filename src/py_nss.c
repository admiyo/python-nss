...
RSAPublicKey_get_modulus(RSAPublicKey *self, void *closure)
{
    ...
    return SecItem_new_from_SECItem(&self->pk->u.rsa.modulus, SECITEM_unknown);
}
...
RSAPublicKey_get_exponent(RSAPublicKey *self, void *closure)
{
    ...
    return integer_secitem_to_pylong(&self->pk->u.rsa.publicExponent);
}
...
static PyObject *
RSAPublicKey_new_from_SECKEYPublicKey(SECKEYPublicKey *pk)
{
    ...
    if (pk->keyType != rsaKey) {
        PyErr_Format(PyExc_AttributeError, "no attribute 'rsa', key_type=%s", key_type_str(pk->keyType));
        return NULL;
    }
    ...
    if ((self->pk = SECKEY_CopyPublicKey(pk)) == NULL) {
        Py_CLEAR(self);
        return set_nspr_error(NULL);
    }
...
DSAPublicKey_get_pqg_params(DSAPublicKey *self, void *closure)
{
    ...
    return KEYPQGParams_new_from_SECKEYPQGParams(&self->pk->u.dsa.params);
}
...
DSAPublicKey_get_public_value(DSAPublicKey *self, void *closure)
{
    ...
    return SecItem_new_from_SECItem(&self->pk->u.dsa.publicValue, SECITEM_unknown);
}
...
{
    PyObject *py_pqg_params = NULL;
    PyObject *py_public_value = NULL;
    PyObject *fmt = NULL;
    PyObject *args = NULL;
    PyObject *str = NULL;
    ...
    if ((py_pqg_params = DSAPublicKey_get_pqg_params(self, NULL)) == NULL) {
        return NULL;
    }

    if ((py_public_value = DSAPublicKey_get_public_value(self, NULL)) == NULL) {
        return NULL;
    }

    PyTuple_SetItem(args, 0, PyObject_Str(py_pqg_params));
    PyTuple_SetItem(args, 1, PyObject_Str(py_public_value));
...
static PyObject *
DSAPublicKey_new_from_SECKEYPublicKey(SECKEYPublicKey *pk)
{
    ...
    if (pk->keyType != dsaKey) {
        PyErr_Format(PyExc_AttributeError, "no attribute 'dsa', key_type=%s", key_type_str(pk->keyType));
        return NULL;
    }
...
PublicKey_get_rsa(PublicKey *self, void *closure)
{
    ...
    if (self->pk->keyType == rsaKey) {
        return RSAPublicKey_new_from_SECKEYPublicKey(self->pk);
    } else {
...
PublicKey_get_dsa(PublicKey *self, void *closure)
{
    ...
    if (self->pk->keyType == dsaKey) {
        return DSAPublicKey_new_from_SECKEYPublicKey(self->pk);
    } else {
...
PublicKey_format_lines(PublicKey *self, PyObject *args, PyObject *kwds)
{
    ...
    case rsaKey:
        if ((py_key = RSAPublicKey_new_from_SECKEYPublicKey(self->pk)) == NULL) {
            goto fail;
        }
        FMT_LABEL_AND_APPEND(lines, _("RSA Public Key"), level, fail);
        CALL_FORMAT_LINES_AND_APPEND(lines, py_key, level+1, fail);
        break;
    case dsaKey:
        break;
    case fortezzaKey:
